...
main()
{
    ...
    std::cout << *circle.get1stDerivative(3.0);
    // std::cout << "\n############## 3D POINTS:\n";
    ...
    //               << *circle.get1stDerivative(path) << "\t|\t"
    //               << "rad + 2*PI = " << std::setw(4) << std::setprecision(5) << path + 2.0f * PI
    //               << std::setw(4) << std::setprecision(5) << "\t"
    ...
    // for(double path{0.0}; path < 4; path += 1)
    //     std::cout << "rad = " << std::setw(4) << std::setprecision(5) << path << "\t\t"
    //               << std::setw(4) << std::setprecision(5) << helix.get1stDerivative(path).first
    //               << "\t|\t"
    //               << "rad + 2*PI = " << std::setw(4) << std::setprecision(5) << path + 2.0 * PI
    //               << std::setw(4) << std::setprecision(5) << "\t"
    //               << helix.get1stDerivative(path + 2.0 * PI).first << "\n";
}
